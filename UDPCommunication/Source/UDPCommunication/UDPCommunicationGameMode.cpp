...
void AUDPCommunicationGameMode::Send(FTransformData Transdata)
{
	FIPv4Endpoint Endpoint;
	FIPv4Endpoint::Parse(FString("127.0.0.1:50001"), Endpoint);
	TransformUdpSocket->SetRate(10);
	TransformUdpSocket->Sendto(Transdata, Endpoint);
}
